...
export CLASSPATH="$CLASSPATH:.:./bin:./config:/hpchome/fcmeng/babel/babellib/*"
for file in `find /hpchome/fcmeng/babel/stanford-corenlp-full-2018-02-27 -name "*.jar"`; do export CLASSPATH="$CLASSPATH:`realpath $file`"; done 
for file in `find /hpchome/fcmeng/babel/lucene-7.4.0 -name "*.jar"`; do export CLASSPATH="$CLASSPATH:`realpath $file`"; done
...
export CLASSPATH="$CLASSPATH:/hpchome/fcmeng/adw/ADW-master/jar/*"
