...
class Constants
{
    ...
    static final int CORENLP_CLIENT_THREAD = 4;
    //static final String DB_PATH = "jdbc:sqlite:/hpchome/fcmeng/doc_sim/docsim.db";
    static final String ANNTXT_DB_CONNSTR = "jdbc:sqlite:/home/fcmeng/PycharmProjects/doc_similarity/20news18828.db";
    static final String STOPWORDS_PATH = "/home/fcmeng/workspace/doc_clustering_proj/doc_similarity_live/res/stopwords.txt";
    ...
    static final int ANNTXT_MAX_TASKS = 4;
    static final int ANNTXT_MAX_CACHED = 500;
    static final int ANNTXT_THREAD_POOL_SIZE = 8;
};
