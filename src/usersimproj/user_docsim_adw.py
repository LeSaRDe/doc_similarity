...
WORD_SIM_MODE = 'adw'
DB_CONN_STR = '/home/fcmeng/doc_sim/docsim_adw.db'
MAX_PROC = 32

DOC1 = 0
DOC2 = 0
OFFLINE_DICT = '/home/fcmeng/doc_sim/ws_offline_dict'
doc_pair_dict = {}
        ...
        for leaf_2 in leaves_2:
            ...
            if WORD_SIM_MODE == 'adw':
                ...
                if sim == float(0):
                    if word_1 == word_2:
                        sim = 1
                #print "[DBG]: word_1 = " + word_1 + " : " + "word_2 = " + word_2 + " : " + "ws_key = " + ws_key + " : " + "sim = " + str(sim)
...
def cal_cycle_weight(cycle, inter_edges):
    ...
    arch_weight = math.exp(3.0 / (math.pow(w1, 3) + math.pow(w2, 3)))
...
def fetchTreeStrFromDB(db_conn, user_id, time_s, time_e):                
    ...
    db_cur = db_conn.execute('''SELECT distinct parse_trees FROM tb_docsim WHERE (user_id = ?) AND (strftime('%Y-%m-%dT%H:%M:%Sz', time) BETWEEN ? AND ?)''', query_in)
    l_tree_str = []
    for row in db_cur:
        #print row[0]
...
def fillDocPairDict(doc1, doc2):
    ...
    dpd_tmp = babel_ADW['(%s,%s)' % (doc1, doc2)]
    for wp in dpd_tmp:
        wp = wp.split(':')
...
def test_main():
    fillDocPairDict('14', '29')
    #sent_treestr_1 = "(ROOT (S (NP L:United#08355791n#2 L:States##3 L:government#05663671n#4) (SBAR (S (S (SBAR (SBAR (S (NP L:President#10467395n#11 L:Robert#11264002n#12 L:Mugabe##13) (VP L:removed#00173338v#14 L:power#08177592n#16))) (SBAR (S (VP L:working#02436963v#21 (NP L:Zimbabwean#03131750a#24 L:opposition#08404188n#25) (S (VP L:bring#01752884v#27 (NP L:change#13387689n#30 L:administration#01135952n#32))))))))))))"
    #sent_treestr_2 = "(ROOT (S (S (NP (NP L:radical#01535270a#2 L:armed#00142407a#3 L:Islamist#10217335n#4 L:group#00031264n#5) (NP L:ties#13947174n#7 (NP L:Tehran#08911421n#9 L:Baghdad#08914193n#11))) (VP L:helped#02547586v#13 (S L:al-Qaida#08013845n#14 (VP L:establish#00664788v#15 (NP (NP L:international#01568375a#17 L:terrorist#10702781n#18 L:training#00893955n#19 L:camp#08478018n#20) (NP L:northern#01605753a#22 L:Iraq#08913434n#23)))))) (NP L:Kurdish#06974558n#25 L:officials#10372373n#26)))"
    sent_treestr_1 = "(ROOT (S (NP L:Party##1 L:sources##2) (SBAR (S (NP (NP L:Senator##4 L:Ridgeway##5) (SBAR (S (VP L:turned##8 (NP L:leader##11 L:Natasha##12 L:Stott##13 L:Despoja##14))))) (VP L:expected##18 (S (VP L:contest##20 (NP (NP L:leadership##22 L:supporters##28 (NP L:Senator##30 L:Bartlett##31) (NP L:Brian##33 L:Greig##34)) (VP L:installed##36 (NP L:interim##38 L:leader##39) (NP L:party##42 L:executive##44) L:Thursday##46)))))))))"
    sent_treestr_2 = "(ROOT (S (S (NP (NP L:Sri##1 L:Lanka##2) L:government##4) (VP L:lift##6 (NP (NP L:four-year##8 L:ban##9) (NP L:Tamil##11 L:Tiger##12 L:rebels##13)) L:Sept.##15 (S (VP L:paving##18 (NP L:peace##22 L:talks##23) (NP L:insurgents##26 (VP L:scheduled##27 (NP L:month##31 L:Thailand##33))))))) (NP L:government##36 L:minister##37) L:Saturday##39))"
    tp_graph, inter_edges, tree_1, tree_2 = treestr_pair_to_graph(sent_treestr_1, sent_treestr_2, 's1', 's2', 0)
    print inter_edges
